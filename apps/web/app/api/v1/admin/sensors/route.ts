...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        let query = `
            SELECT s.id, s.owner_id, s.slug, s.display_name, s.category, s.description, s.tags, s.vendor, s.total_downloads, s.created_at, s.updated_at, s.is_certified, s.status, s.github_pr_url, s.repository_url, s.docs_url,
